                ...
                <div className="portfolio-flex-wrapper">
                    <div className="cardsWrapper">
                        ...
                        <div index-attribute="1" className="portfolio-card" ref={(el) => (cardsRef.current[1] = el)}>
                            ...
                            <img style={{ pointerEvents: 'none' }} src="video-player-streaming-svgrepo-com.svg" />
                        </div>
                    ...
                    <div className="portfolio-items-wrapper">
                        ...
                        <span data-visibility="inactive" index-attribute="1" ref={(el) => (portfolioItemsRef.current[1] = el)} className="portfolio-item-class" id="discord-portfolio-item" >
                            <PortfolioItem projectName="$App Name: Bally Live"
                                projectDescription="Livestreaming platform for kickboxing, baseball, and volleyball. Built with Nextjs and love."
                                projectLink="https://www.ballylive.com" />
                        </span>

                        <span data-visibility="inactive" index-attribute="2" ref={(el) => (portfolioItemsRef.current[2] = el)} className="portfolio-item-class" id="gtg-portfolio-item">
